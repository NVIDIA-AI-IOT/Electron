...
detectNet* detectNet::Create( int argc, char** argv )
{
	...
	{
		modelName = "InitialLegNet/snapshot_iter_117.caffemodel";
		const char* prototxt = "InitialLegNet/deploy.prototxt";
		const char* input    = "data";
		const char* out_cvg  = "coverage";
		const char* out_bbox = "bboxes";
